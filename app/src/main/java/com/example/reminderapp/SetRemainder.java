...
import com.example.reminderapp.data.AlarmReminderDbHelper;
import com.getbase.floatingactionbutton.FloatingActionButton;

public class SetRemainder extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.set_remainder);
        ...
        reminderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if(flag)
                {
                    ...
                    String mTime = getIntent().getExtras().getString("time");

                    Intent intent = new Intent(SetRemainder.this, AddReminderActivity.class);

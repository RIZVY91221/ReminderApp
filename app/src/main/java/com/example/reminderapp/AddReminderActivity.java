...
import com.example.reminderapp.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDate = Objects.requireNonNull(getIntent().getExtras()).getString("date");
        mTime = getIntent().getExtras().getString("time");
        Toast.makeText(AddReminderActivity.this,"Date = "+mDate,Toast.LENGTH_LONG).show();
        Toast.makeText(AddReminderActivity.this,"time = "+mTime,Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                // which is the {@link SetRemainder}.
